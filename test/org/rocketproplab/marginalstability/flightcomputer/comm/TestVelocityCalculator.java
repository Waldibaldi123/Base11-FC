...
public class TestVelocityCalculator {
  ...
  public void testGetVelocity1() {
    ...
    assertEquals(1, VelocityCalculator.getSpeed(prevpacket, curpacket), EPSILON);
  }
  ...
  public void testGetVelocity2() {
    ...
    GPSPacket curpacket = new GPSPacket(nEMA2);
    Vector3 velocity = VelocityCalculator.getVelocityVector(prevpacket, curpacket);
    ...
    assertEquals(71309325.8434687489228, VelocityCalculator.getSpeed(prevpacket, curpacket), EPSILON);
  }
}
